...
class BodyParamsContract::MissingParams
  def self.[](*_); end
...
class Hanami::API
  def self.delete(*args, **kwargs, &blk); end

  def self.get(*args, **kwargs, &blk); end

  def self.inherited(app); end

  def self.link(*args, **kwargs, &blk); end

  def self.mount(*args, **kwargs, &blk); end

  def self.options(*args, **kwargs, &blk); end

  def self.patch(*args, **kwargs, &blk); end

  def self.post(*args, **kwargs, &blk); end

  def self.put(*args, **kwargs, &blk); end

  def self.redirect(*args, **kwargs, &blk); end

  def self.root(*args, **kwargs, &blk); end

  def self.router(); end

  def self.scope(*args, **kwargs, &blk); end

  def self.trace(*args, **kwargs, &blk); end

  def self.unlink(*args, **kwargs, &blk); end

  def self.use(middleware, *args, &blk); end
end
...
class Hanami::Router
  ...
  def initialize(base_url: T.unsafe(nil), prefix: T.unsafe(nil), resolver: T.unsafe(nil), block_context: T.unsafe(nil), &blk); end
  ...
  DEFAULT_REDIRECT_CODE = ::T.let(nil, ::T.untyped)
...
class Hanami::Router::Error
end

class Hanami::Router::Error
end

class Hanami::Router::InvalidRouteException
...
class Hanami::Router::InvalidRouteExpansionException
...
class Hanami::Router::MissingEndpointError
...
class Hanami::Router::Params
  def self.deep_symbolize(params); end
end
...
class Hanami::Router::Prefix
  ...
  DEFAULT_SEPARATOR_REGEXP = ::T.let(nil, ::T.untyped)
  DOUBLE_DEFAULT_SEPARATOR_REGEXP = ::T.let(nil, ::T.untyped)
end
...
class Hanami::Router::Redirect
  ...
  def initialize(destination, endpoint); end
end
...
class Hanami::Router::Segment
  def self.fabricate(segment, **constraints); end
end
...
class Hanami::Router::UnknownHTTPStatusCodeError
...
class Mustermann::StringScanner
  ...
  def check(pattern, **options); end

  def check_until(pattern, **options); end

  def eos?(); end

  def getch(); end

  def initialize(string=T.unsafe(nil), **pattern_options); end
  ...
  def scan(pattern, **options); end

  def scan_until(pattern, **options); end
...
class Mustermann::StringScanner::ScanResult
  def initialize(scanner, position, length, params=T.unsafe(nil)); end
...
class Mustermann::Visualizer::Highlight
  ...
  BASE_THEME = ::T.let(nil, ::T.untyped)
  DEFAULT_THEME = ::T.let(nil, ::T.untyped)
end
...
class Object
  ...
  APP_STACK = ::T.let(nil, ::T.untyped)
  ARGF = ::T.let(nil, ::T.untyped)
  ARGV = ::T.let(nil, ::T.untyped)
  CROSS_COMPILING = ::T.let(nil, ::T.untyped)
  ENV = ::T.let(nil, ::T.untyped)
  PRODUCTS = ::T.let(nil, ::T.untyped)
